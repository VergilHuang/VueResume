<template>
  <div class="about">
    <section>
      ...
      <p
        class="about-text"
      >2008年，大學就讀工業與系統工程科系。在一次C語言的課程中喜歡上了編程這件事，後來修習了自動化倉儲系統編程與自走車設計並參加了校際比賽獲得第三名，也從此喜歡上了編程的道路。</p>
      <p class="about-text">
        2015年，在台北市一家科技公司擔任
        <b>iOS工程師</b>，跟著小組成員一起設計了兩款基於藍牙功能，用於自動同步Web database資料與硬體信標資料的企業版App，與一款基於藍牙信標的定點公車服務App。第二年開始負責產品部門管理工作，同時全面接手網站系統開發部門的
        ...
        <a
          ...
          target="_blank"
        >桃園市市政信箱網站</a>、
        <a class="t-link" href="https://crpd.sfaa.gov.tw/" target="_blank">CRPD身心障礙者權利公約網站</a>與部分相關的內部系統。
      </p>

      <p
        class="about-text"
      >2019年，在吉聯數位擔任前端團隊主管，依照產品需求，打造了可高效處理上百支外觀結構各異的web app專案架構，實現所有資源檔獨立且統一管理，大大減少了佈署成本與專案管理成本。</p>
    </section>
    <section>
      <h3>My Service</h3>
      <div>
        <Services v-for="service in services_data" :key="service.id" :service="service" />
      </div>
    </section>
    <section>
      <h3>My Skills</h3>
    ...
    return {
      services_data: [
        ...
        },
        {
          ...
          text:
            "熟知無障礙網站設計流程，為無障礙人士設計好用的網站。設計的網站曾通過國家2A等級無障礙標章。"
        },
        {
          id: 4,
          icon: "eye",
